module NoMoreCss.Main where
    ...
    font = concat [
          withFontPxConfig  "lineh" "line-height"
        , withFontRemConfig "lineh" "line-height"
        , withFontPxConfig  "fontsize" "font-size"
        , withFontRemConfig "fontsize" "font-size"
        ]
    ...
    display = [
          Selector { selector = "dblock", props = [("display", "block")] }
        , Selector { selector = "dinlineblock", props = [("display", "inline-block")] }
        , Selector { selector = "dinline", props = [("display", "inline")] }
        , Selector { selector = "dflex", props = [("display", "flex")] }
        ]
